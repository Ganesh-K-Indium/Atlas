    ...
    sections: [
      {
        ...
        items: [
          { title: "Tokenizers: BPE, WordPiece, SentencePiece", slug: "tokenizers", status: "published", difficulty: "intermediate" },
          { title: "Word & Token Embeddings", slug: "embeddings", status: "published", difficulty: "intermediate" },
      ...
      },
      {
        ...
        items: [
          { title: "Pretraining Objectives & Scaling Laws", slug: "pretraining-scaling-laws", status: "published", difficulty: "advanced" },
          { title: "Supervised Fine-Tuning (SFT)", slug: "supervised-fine-tuning", status: "published", difficulty: "intermediate" },
          { title: "RLHF: Reward Modeling & PPO", slug: "rlhf", status: "published", difficulty: "expert" },
          { title: "Direct Preference Optimization (DPO)", slug: "dpo", status: "published", difficulty: "advanced" },
      ...
      },
      {
        ...
        items: [
          { title: "KV Cache & Attention at Inference", slug: "kv-cache", status: "published", difficulty: "advanced" },
          { title: "FlashAttention", slug: "flash-attention", status: "published", difficulty: "expert" },
          { title: "Quantization: INT8, GPTQ, AWQ", slug: "quantization", status: "published", difficulty: "advanced" },
          { title: "Speculative Decoding", slug: "speculative-decoding", status: "published", difficulty: "advanced" },
          { title: "Serving with vLLM & TensorRT-LLM", slug: "serving-vllm-tensorrt", status: "published", difficulty: "advanced" },
        ],
      },
      {
        ...
        items: [
          { title: "LLM Evaluation Methods & Benchmarks", slug: "llm-evaluation", status: "published", difficulty: "intermediate" },
          { title: "Guardrails & Responsible AI", slug: "guardrails-responsible-ai", status: "published", difficulty: "intermediate" },
          { title: "AI Alignment & Safety", slug: "ai-alignment-safety", status: "published", difficulty: "advanced" },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        slug: "architectures",
        items: [
          { title: "Reasoning, Planning & Tool Calling", slug: "reasoning-planning-tool-calling", status: "published", difficulty: "advanced" },
          { title: "Agent Memory Systems", slug: "agent-memory", status: "published", difficulty: "advanced" },
          { title: "Multi-Agent Systems", slug: "multi-agent-systems", status: "published", difficulty: "advanced" },
        ],
      },
      {
        ...
        items: [
          ...
          { title: "Agent2Agent Protocol (A2A)", slug: "agent2agent-protocol", status: "published", difficulty: "intermediate" },
          { title: "LangChain & LangGraph", slug: "langchain-langgraph", status: "published", difficulty: "intermediate" },
          { title: "CrewAI & AutoGen", slug: "crewai-autogen", status: "published", difficulty: "intermediate" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        slug: "production-ml",
        items: [
          { title: "Feature Engineering & Feature Stores", slug: "feature-engineering", status: "published", difficulty: "intermediate" },
          { title: "Experiment Tracking (MLflow, W&B)", slug: "experiment-tracking", status: "published", difficulty: "beginner" },
          { title: "ML Pipelines & Orchestration", slug: "ml-pipelines", status: "published", difficulty: "intermediate" },
          { title: "Model Serving & Deployment", slug: "model-serving", status: "published", difficulty: "advanced" },
          { title: "Monitoring & Observability", slug: "monitoring-observability", status: "published", difficulty: "advanced" },
          { title: "Docker, Kubernetes & CI/CD for ML", slug: "docker-kubernetes-cicd", status: "published", difficulty: "intermediate" },
        ],
      },
      {
        ...
        slug: "cloud-big-data",
        items: [
          { title: "AWS for ML (SageMaker, Bedrock)", slug: "aws-for-ml", status: "published", difficulty: "intermediate" },
          { title: "Azure & GCP ML Platforms", slug: "azure-gcp-ml", status: "published", difficulty: "intermediate" },
          { title: "Databricks & Spark", slug: "databricks-spark", status: "published", difficulty: "intermediate" },
          { title: "Snowflake for ML Workloads", slug: "snowflake-ml", status: "published", difficulty: "intermediate" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        slug: "interview-prep",
        items: [
          { title: "ML System Design", slug: "ml-system-design", status: "published", difficulty: "advanced" },
          { title: "Coding Problems for ML/DS", slug: "coding-problems", status: "published", difficulty: "intermediate" },
          { title: "Case Studies", slug: "case-studies", status: "published", difficulty: "intermediate" },
        ],
      },
      {
        title: "Reference",
        slug: "reference",
        items: [
          { title: "Glossary", slug: "glossary", status: "published", difficulty: "beginner" },
          { title: "Timeline of AI", slug: "timeline-of-ai", status: "published", difficulty: "beginner" },
          { title: "Cheat Sheets", slug: "cheat-sheets", status: "published", difficulty: "beginner" },
        ],
      },
    ],
  },
